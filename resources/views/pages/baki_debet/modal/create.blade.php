...
<div class="layout-form hidden" id="add-baki-debet">
    ...
    <form id="modal-add-form">
        <div class="p-4 space-y-8 mt-8">
            ...
            <button data-dismiss-id="add-baki-debet" type="button" class="bg-white ml-2 px-8 rounded text-theme-text border py-2">
                Batal
            </button>
        </div>
        <input type="hidden" class="p-2 w-full border" id="add_jenis" name="jenis" value="bade"/>
    </form>
</div>
