                            ...
                            <table class="table mt-2">
                                <thead>
                                    <tr class="bg-danger text-light">
                                        ...
                                        <th scope="col">Role Notifikasi</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        {{-- <td>Antoni</td> --}}
                                        <td>Mohon Untuk Mengisikan Penyerahan Unit</td>
                                        <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Non saepe repellendus
                                            laudantium temporibus. Sequi, rem dicta. Aut adipisci accusantium autem.</td>
                                        <td>Cabang</td>
                                        <td>
                                            <div class="dropdown">
