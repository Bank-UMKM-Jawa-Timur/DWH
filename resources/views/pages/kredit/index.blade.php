                                            ...
                                            <td>
                                                @if ($buktiPembayaran)
                                                    @if ($buktiPembayaran->is_confirm)
                                                        ...
                                                        @endif
                                                    @else
                                                    <span class="text-danger">Menunggu konfirmasi bukti pembayaran</span>
                                                    @endif
                                                @else
                                            ...
                                            <td>
                                                @if ($item->tgl_ketersediaan_unit)
                                                    @if ($penyerahanUnit)
                                                        {{$penyerahanUnit->date}}
                                                    @else
                                                    <span class="text-info">Maksimal tanggal penyerahan unit {{ date('Y-m-d', strtotime($item->tgl_ketersediaan_unit . ' +1 days')) }}</span>
                                                    @endif
                                                @else
                                            ...
                                            <td>
                                                @if ($penyerahanUnit)
                                                    @if ($stnk)
                                                        ...
                                                        @endif
                                                    @else
                                                    <span class="text-info">Maksimal tanggal upload STNK {{ date('Y-m-d', strtotime($penyerahanUnit->date . ' +1 month')) }}</span>
                                                    @endif
                                                @else
                                                <span class="text-danger">Menunggu tanggal ketersediaan unit</span>
                                                @endif
                                            ...
                                            <td>
                                                @if($penyerahanUnit)
                                                    @if ($polis)
                                                        ...
                                                        @endif
                                                    @else
                                                        <span class="text-info">Maksimal tanggal upload Polis {{ date('Y-m-d', strtotime($penyerahanUnit->date . ' +1 month')) }}</span>
                                                    @endif
                                                @else
                                                <span class="text-danger">Menunggu tanggal ketersediaan unit</span>
                                                @endif
                                            ...
                                            <td>
                                                @if($penyerahanUnit)
                                                    @if ($bpkb)
                                                        ...
                                                        @endif
                                                    @else
                                                    <span class="text-info">Maksimal tanggal upload Polis {{ date('Y-m-d', strtotime($penyerahanUnit->date . ' +3 month')) }}</span>
                                                    @endif
                                                @else
                                                <span class="text-danger">Menunggu tanggal ketersediaan unit</span>
                                                @endif
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        @if (!$buktiPembayaran)
                                                            <a class="dropdown-item" data-toggle="modal" data-target="#buktiPembayaranModal"
                                                            data-id_kkb="{{ $item->kkb_id }}" href="#" onclick="uploadBuktiPembayaran({{ $item->kkb_id }})">Upload Bukti Pembayaran</a>
                                                        @endif
                                                        @if ($buktiPembayaran)
                                                        ...
                                                        @if ($item->tgl_ketersediaan_unit)
                                                            @if (!$penyerahanUnit)
                                                                <a data-toggle="modal" data-target="#tglModalPenyerahan"
                                                                    ...
                                                                    onclick="setPenyerahan({{ $item->kkb_id }})">Kirim Unit</a>
                                                            @endif
                                                        @endif
                                                        {{--  STNK  --}}
                                                        {{--  @if ($stnk)
                                                        ...
                                                        @if (Auth::user()->role_id == 3)
                                                            ...
                                                            data-id_kkb="{{ $item->kkb_id }}" data-no-stnk="@isset($stnk->text){{$stnk->text}}@endisset"
                ...
                <div class="modal-body">
                    <form id="modal-berkas" enctype="multipart/form-data">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="stnk-tab" data-toggle="tab" href="#stnk" role="tab" aria-controls="stnk" aria-selected="true">STNK</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="polis-tab" data-toggle="tab" href="#polis" role="tab" aria-controls="polis" aria-selected="false">Polis</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="bpkb-tab" data-toggle="tab" href="#bpkb" role="tab" aria-controls="bpkb" aria-selected="false">BPKB</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            {{--  STNK  --}}
                            <div class="tab-pane fade show active" id="stnk" role="tabpanel" aria-labelledby="stnk-tab">
