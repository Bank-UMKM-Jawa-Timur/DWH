<div class="layout-form hidden" id="edit-perusahaan-asuransi">
    ...
    <form id="modal-edit-form">
        ...
        <div class="p-4 space-y-8 mt-8">
            <div class="input-box space-y-3">
                ...
                <input type="text" class="p-2 w-full border" id="edit-nama"
                    name="nama" required/>
            </div>
            <div class="input-box space-y-3">
                <label for="" class="uppercase appearance-none">Alamat</label>
                <textarea class="block w-full border" name="" id="edit-alamat" cols="30" rows="10"></textarea>
            </div>
            <div class="input-box space-y-3">
                <label for="" class="uppercase appearance-none">Nomor HP</label>
                <input type="text" class="p-2 w-full border" name="telp" id="edit-telp"
                    required />
            </div>
            <button class="bg-theme-primary px-8 rounded text-white py-2" id="edit-button">
                Simpan
            </button>
            <button data-dismiss-id="edit-perusahaan-asuransi" type="button"
