    ...
    <script>
        ...
        $('#pengajuan').on('change', function() {
            ...
            tempMonth = (tanggalAwalKredit.getMonth() + 1).toString().length == 1 ?
                `0${tanggalAwalKredit.getMonth() + 1}` : tanggalAwalKredit.getMonth() + 1;
            var fullTanggalAwalKredit =
                `${tanggalAwalKredit.getDate()}-${tempMonth}-${tanggalAwalKredit.getFullYear()}`;
            var tenor = parseInt(data[key]['tenor_yang_diminta']);
            var tanggalAkhirKredit = new Date(tempTanggalAwalKredit.setMonth(tempTanggalAwalKredit.getMonth() +
                tenor));
            tempMonth = (tanggalAkhirKredit.getMonth() + 1).toString().length == 1 ?
                `0${tanggalAkhirKredit.getMonth() + 1}` : tanggalAkhirKredit.getMonth() + 1;
            var fullTanggalAkhirKredit =
                `${tanggalAkhirKredit.getDate()}-${tempMonth}-${tanggalAkhirKredit.getFullYear()}`;
            ...
            // Get jenis asuransi by skema kredit
            $('#jenis_asuransi').empty()
            $('#jenis_asuransi').append(`<option selected value="">-- Pilih Jenis Asuransi ---</option>`)
            $.ajax({
                url: "{{ route('asuransi.registrasi.jenis_asuransi') }}",
                type: "GET",
                accept: "Application/json",
                data: {
                    'jenis_kredit': data[key]['skema_kredit'],
                },
