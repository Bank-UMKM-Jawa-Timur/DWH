...
@push('extraScript')
    <script>
        var optionsPengajuanKlaimDetail = {
            labels: ['Sudah', 'Belum'],
            series: [55, 70],
            chart: {
                type: 'donut',
        ...
        var pengajuanKlaimDetail = new ApexCharts(document.querySelector(".chart-asuransi-detail"), optionsPengajuanKlaimDetail);
        pengajuanKlaimDetail.render();
