                                ...
                                @forelse ($result as $item)
                                    <tr>
                                        ...
                                        @elseif ($role == 'Penyelia Kredit')
                                            ...
                                            @endif
                                        @endif
                                        <td>{{$item['dibayar'] + $item['belum_dibayar']}}</td>
                                        <td>{{$item['dibayar']}}</td>
...
@push('extraScript')
    <script>
        var sudah_bayar = @json($sudah_bayar);
        var belum_bayar = @json($belum_bayar);
        var total = sudah_bayar + belum_bayar

        // chart Registrasi
        var optionsRegistrasi = {
            labels: ['Sudah', 'Belum'],
            series: [sudah_bayar, belum_bayar],
            chart: {
                type: 'donut',
                width: '100%',
                height: 480,
