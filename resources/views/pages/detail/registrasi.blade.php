...
@push('extraScript')
    <script>
        ...
        var registrasiDetail = new ApexCharts(document.querySelector(".chart-asuransi-detail"), optionsAsuransiRegistrasi);
        registrasiDetail.render();
