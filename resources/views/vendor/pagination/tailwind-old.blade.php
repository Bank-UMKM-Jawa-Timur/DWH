                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <button class="w-10 h-10 text-white transition-colors duration-150 bg-theme-primary border border-r-0 border-theme-primary focus:shadow-outline">{{ $page }}</button>
                                    </span>
                                @else
