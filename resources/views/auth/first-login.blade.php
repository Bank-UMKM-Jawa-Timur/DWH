...
<head>
    ...
    <title>Data Warehouse | First Login</title>
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <form class="login-form" action="{{ route('first-login.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group form-floating-label">
                    <button type="submit" class="btn btn-danger btn-login">Change Password</button>
                </div>
