...
Route::middleware('auth_api')->group(function () {
    ...
    Route::prefix('asuransi')->group(function() {
        ...
        Route::get('/pelaporan-pelunasan/create', [PelaporanPelunasanController::class, 'create'])->name('pelaporan_pelunasan.create');
        Route::resource('/pengajuan-klaim', PengajuanKlaimController::class);
        Route::get('/pengajuan-klaim/create', [PengajuanKlaimController::class, 'create'])->name('pengajuan_klaim.create');
